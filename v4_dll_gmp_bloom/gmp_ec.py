...
# =============================================================================    
	def __str__(self):
		if self == self.IDENTITY_ELEMENT:
			...
			return 'X: 0x{:064x}\nY: 0x{:064x}'.format(self.x, self.y)
# =============================================================================        
...
GTable = make_32_256Table()

# =============================================================================

def Point_Multiplication(k, A=G, p=modulo):
    parts = number_32parts(k)
    result = Zp
    for i in range(len(parts)):
        if parts[i] != 0:
            m = parts[i]
            result = Point_Addition(result, GTable[i][m-1])
    return result
# =============================================================================
