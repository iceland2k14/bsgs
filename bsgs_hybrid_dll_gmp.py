...
"""
Usage :
 > python bsgs_hybrid_dll_gmp.py -pfile test_pubkeys.txt -b FULLbpfile.bin -bl Big5GB_dll_bloom.bin -n 80000000000000 -keyspace 800000000000000000000000000000:FFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
 > python bsgs_hybrid_dll_gmp.py -pfile Pub50.txt -b FULLbpfile.bin -bl Big5GB_dll_bloom.bin -n 8000000000 -rand1
...
if os.path.isfile(bs_file) == False:
    ...
    print('Specify the input file used to create the bloom filter or create it from : create_bPfile_mcpu.py. Even little smaller file is OK.')
    sys.exit()
...
st = time.time()
print('[+] Starting Program : BSGS mode with hybrid algo using bloom dll')
